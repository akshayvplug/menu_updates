...
class Menu():
    ...
    #         product_container_type = type(category['products']['product'])
    #         print(f" Product container type : {product_container_type}")

    #         # Category containing only 1 product is represented
    #         # directly as a dict rather than usual list of dict.
    #         if isinstance(category['products']['product'], dict):
    #             self.product_names.append(category['products']['product']['@name'])
    #             print(f"Appending {category['products']['product']['@name']}")
    #             self.products.append(category['products']['product'])
    #             continue

    #         for prod in category['products']['product']:

    #             print(f"Processing for category {category['@name']} AND TYPE : {type(prod)}")
...
#         print(f"Processing for {id} - {p.get('@name')}")
